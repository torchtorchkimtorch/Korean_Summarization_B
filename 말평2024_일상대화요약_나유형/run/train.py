...
g.add_argument("--model_id", type=str, help="model file path")
...
def main(args):
    ...
    model_position = ""
    if args.checkpoint:
        model_position = args.checkpoint
    else:
        model_position = args.model_id
    ...
    train_dataset = CustomDataset("resource/data/new_train_cutted_fixed.json", tokenizer)
